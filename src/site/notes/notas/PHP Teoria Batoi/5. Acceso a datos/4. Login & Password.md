---
{"dg-publish":true,"permalink":"/notas/php-teoria-batoi/5-acceso-a-datos/4-login-and-password/"}
---


![imagenes/06/06-login-password.gif](/img/user/notas/PHP%20Teoria%20Batoi/imagenes/06/06-login-password.gif)
