---
{"dg-publish":true,"permalink":"/01-apuntes/vue-teoria-batoi/03-1-sfc/"}
---
...
![Nuevo Proyecto](/img/user/01 Apuntes/Vue Teoria Batoi/img/npm-init-vue.png)
...
![Proyecto de plantilla simple](/img/user/01 Apuntes/Vue Teoria Batoi/img/vue-vite-sample-app.png)

### _Scaffolding_ creado
Se ha creado la carpeta con el nombre del proyecto y dentro el scaffolding para nuestro proyecto:

![Directorios del proyecto de plantilla simple](/img/user/01 Apuntes/Vue Teoria Batoi/img/vue-vite-sample-folders.png)
...
![Depurar en la consola](/img/user/01 Apuntes/Vue Teoria Batoi/img/console-vite.png)
...
![Vue DevTools](/img/user/01 Apuntes/Vue Teoria Batoi/img/console-vue_devtools.png)
